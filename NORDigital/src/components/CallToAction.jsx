...
export const CallToAction = () => {
  return (
    <section className="relative flex flex-col items-center justify-center pb-12 px-4" aria-labelledby="cta-heading">
        <Container className="relative rounded-xl bg-gradient-to-r from-[#F4C3B4] to-[#C39C90] bg-opacity-90 p-8 md:p-12 max-w-2xl mx-auto shadow-lg transform hover:shadow-xl transition-shadow duration-300">
            <div className="flex flex-col items-center text-center space-y-4 md:space-y-6">
                ...
                {/* Titre de la section */}
                <h2 id="cta-heading" className="text-2xl md:text-3xl font-bold text-gray-800">
                ...
                <div className="mt-6">
                    <Button
                        ...
                        className="text-pri-a-1 bg-gradient-to-r from-pri-a-2 to-pri-c-1 px-6 py-3 text-lg font-semibold hover:scale-105 transition-transform duration-300"
                    >
                        Prendre contact
                    </Button>
                </div>
