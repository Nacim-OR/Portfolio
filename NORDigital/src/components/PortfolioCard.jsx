...
const projects = [
    ...
    },
    {
        ...
        url: null, // Pas de lien, juste une pop-up avec détails
    },
    {
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 transform hover:scale-105 transition duration-300">
            <div className="flex flex-col items-center space-y-4">
                ...
                <button
                    ...
                    className="mt-4 px-4 py-2 rounded-lg bg-pri-a-2 text-pri-a-1 font-bold hover:bg-pri-a-1 hover:text-pri-a-1 animate"
                >
                    En savoir plus
                </button>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-pri-a-1 rounded-lg">
                            {projects.map((project, index) => (
                                <div
                                    ...
                                    onClick={() => project.url ? window.open(project.url, "_blank") : openPopup(project)}
                                >
                                    {/* Image du projet */}
                                    <img
                                        src={project.image}
                                    ...
                                    <div className="absolute inset-0 bg-black bg-opacity-50 opacity-0 hover:opacity-100 transition-opacity flex items-center justify-center text-center text-white font-bold p-4">
                                        <div>
